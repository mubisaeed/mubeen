...
@section('content')
  {{-- <div>
    ...
    <form method="POST" action="/safetytips/edit/{{$safetytip->id}}" enctype="multipart/form-data">
      ...
      <input type="text" name="description" value="{{old('title', $safetytip->description)}}" required minlength="10" maxlength="3000">
      @error('description')
      <div>
        {{$message}}
      </div>
  ...
  <div class="breadcrumb_main">
    <ol class="breadcrumb">
      <li><a href = "#">Home</a></li>
      <li class = "active">Edit new Safety Tip</li>
    </ol>
  </div>  
    ...
    <div class="profile_main">
      ...
      <div class="profile mt-0">
        <div class="course card-header card-header-warning card-header-icon">
          ...
          <h3 class="main_title_ot">Edit new Safety Tip</h3>
