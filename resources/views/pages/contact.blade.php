                ...
                <div class="row">
                  ...
                  <div class="col-md-6 p_right">
                    ...
                    <div class="custom_input_main mobile_field">
                      ...
                      <input type="tel" class="form-control" name="phno" value="{{old('phno',$contact->phone)}}" placeholder="xxxx-xxxxxxx" pattern="03[0-9]{2}-(?!1234567)(?!1111111)(?!7654321)[0-9]{7}" required="" minlength="12" maxlength = "12" autofocus="">
