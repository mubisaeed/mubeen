                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 p_left">
                      ...
                      <div class="file_spacing">
                        ...
                        <input id="file" class="choose" type="file" name="file" accept=".doc,.docx,.pptx,.xlsx,.txt,application/pdf,application/vnd.ms-excel/application/vnd.ms-docx,image/*" autofocus="" size="max:10240" required="">
