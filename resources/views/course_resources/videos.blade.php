                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="custom_input_main">
                        ...
                        <textarea class="form-control" name="short_des" rows="4" cols="50" value="{{old('short_description')}}" minlength="10" maxlength ="1000" style="height: 100px !important;"required=""></textarea>
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="file_spacing">
                        ...
                        <input id="file" onchange="ValidateSize(this)" type="file" class="choose" name="video" accept="video/mp4,video/x-m4v,video/x-wmv,video/*" size="max:10240" required="">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="first_row"><div class="limit_description">{{$cr->short_description}}</div></td>
                  ...
                  <td class="first_row"><iframe src="{{asset('storage/'.$cr->file)}}" height="70" width="70">{{($cr->file)}}</iframe></td>
