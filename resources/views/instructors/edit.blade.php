              ...
              <div class="s_profile_fields">
                <div class="row">
                  ...
                  <div class="col-md-6 p_right">
                    <div class="custom_input_main mobile_field">
                      <input type="email" class="form-control" name="email"value="{{old('email',$instructor->email)}}"  required maxlength="255"autofocus="">
                ...
                <div class="col-md-6 p_right">
                    <div class="custom_input_main mobile_field">
                      <input type="tell" class="form-control" name="phno" value="{{old('phno',$instructor->phone)}}" placeholder="xxxx-xxxxxxx" pattern="03[0-9]{2}-(?!1234567)(?!1111111)(?!7654321)[0-9]{7}" required="" minlength="12" maxlength = "12" autofocus="">
                  ...
                  <div class="col-md-6 p_left">
                    <div class="custom_input_main mobile_field">
                      <input type="text" class="form-control" value="{{old('cnic',$instructor->cnic)}}" name="cnic"class="mb-4" minlength="13" maxlength="15"  placeholder="XXXXX-XXXXXXX-X"  required="" autofocus="">
                  ...
                  <div class="col-md-6 p_right">
                    <div class="custom_input_main mobile_field">
                      <input type="text" class="form-control" value="{{old('add',$instructor->address)}}"  name="add" class="mb-4" required="" minlength="3" maxlength ="200" autofocus="">
