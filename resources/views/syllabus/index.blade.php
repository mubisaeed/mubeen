                      ...
                      <input type="hidden" name="course_id" value="{{$id}}">
                        ...
                        <div class="col-md-6 p_right">
                          ...
                          <div class="file_spacing">
                            ...
                            <input id="file" class="choose" type="file" name="file" value="{{old('file')}}" accept=".doc,.docx,.pptx,.xlsx,.txt,application/pdf,application/vnd.ms-excel/application/vnd.ms-docx,image/*" autofocus="" size="max:10240">
            ...
            <table class="table table-hover" id="table-id">
              ...
              <tbody id="mybody">
                ...
                <tr>
                  ...
                  <td class="first_row">
                    <div class="course_td">
                      <iframe src="https://view.officeapps.live.com/op/embed.aspx?src={{asset('/assets/img/documents/'.$sylbus->document)}}" width='100' height='100px' frameborder='0'></iframe>
                    </div>
                  </td>
                  
                  <td class="first_row">
                    {!! substr($sylbus->description, 0, 5) !!}
                  </td>
