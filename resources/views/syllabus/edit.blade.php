                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 p_right">
                          ...
                          <div class="file_spacing">
                            ...
                            <input id="file" class="choose" type="file" name="file" value="{{old('file', $syllabus->document)}}" accept=".doc,.docx,.pptx,.xlsx,.txt,application/pdf,application/vnd.ms-excel/application/vnd.ms-docx,image/*" autofocus="" size="max:10240">
                            <iframe src="https://view.officeapps.live.com/op/embed.aspx?src={{asset('/assets/img/documents/'.$syllabus->document)}}" width='100' height='100px' frameborder='0'></iframe>
