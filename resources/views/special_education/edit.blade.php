...
<!-- 
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="file_spacing">
                        ...
                        <input id="file" class="choose" type="file" name="image" value="{{old('image',$special_education->signature)}}" accept="image/*" required="" autofocus="" size="max:255"> 
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="custom_input_main">
                        ...
                        <textarea class="form-control" name="text" rows="4" cols="50" value="{{old('text',$special_education->text_information)}}" minlength="10" maxlength ="255" style="height: 100px !important;" required="">{{$special_education->parent_comments}}</textarea>
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="s_form_button text-center">
                        ...
                        <a  href="{{url('/')}}"><button type="button" class="btn cncl_btn">Cancel</button></a>
