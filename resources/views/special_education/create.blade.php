                ...
                <form action="{{url('/special_education/store')}}" method="POST" enctype="multipart/form-data" class="w-100">
                  ...
                  <div class="row">
                      ...
                      <div class="file_spacing">
                        ...
                        <input id="file" class="choose" type="file" name="file" accept=".doc,.docx,.pptx,.xlsx,.txt,application/pdf,application/vnd.ms-excel/application/vnd.ms-docx/mp4,video/x-m4v,video/x-wmv,video/*" required="" autofocus="" size="max:10240" required="">
