             ...
             <table class="table">
                 ...
                 <tbody>
                     ...
                     @foreach($allClasses as $clas)
                      ...
                      <th> {{$clas->name}} </th>
                      <th>  
                      <input type="checkbox" name="clas_id[]" value="{{$clas->id}}"> 
                      </th>
                      </tr>
                     @endforeach
               ...
               <button class="btn btn-primary" type="submit"> Add Classes to   {{DB::table('departments')->where('id' , $id)->pluck('name')->first()}} department  </button>
             </form>
