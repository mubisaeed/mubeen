    ...
    <div class="profile mt-0">
      ...
      <div class="course card-header card-header-warning card-header-icon">
        ...
        <div class="tab-content">
          ...
          <form method="POST" action="{{ url('/sub_adminstore') }}" enctype="multipart/form-data">
              ...
              <div class="s_profile_fields">
                ...
                <div class="col-md-6 p_right">
                    ...
                    <div class="custom_input_main mobile_field">
                        ...
                        <input type="tell" class="form-control" name="contact" value="{{ old('contact')}}" placeholder="xxxx-xxxxxxx" pattern="03[0-9]{2}-(?!1234567)(?!1111111)(?!7654321)[0-9]{7}" required="" minlength="12" maxlength = "12" autofocus="">
