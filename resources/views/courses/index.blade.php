                ...
                <td class="align_ellipse first_row">
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                      ...
                      <a class="dropdown-item" href="{{url('resource/download/'.$course->id)}}" target="_blank"> <i class="fa fa-eye"></i>Links</a>
                      <a class="dropdown-item" href="{{url('/courseresourse/'. $course->id)}}"> <i class="fa fa-file" aria-hidden="true"></i>Resourses</a>
