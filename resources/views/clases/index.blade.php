                ...
                <tr>
                 ...
                 <th scope="row">{{$count}}   </th>
                  ...
                  <!-- <td>
                    ...
                    <a href="{{url('/class/showinstructor/ofclass/'.$class->id)}}" class="btn btn-success btn-sm"> Show Instructors </a>
                          
                  </td> -->

                  <td>
                      
                    <a href="{{url('/class/addcourse/toclass/'.$class->id)}}" class="btn btn-success btn-sm"> Add course</a>
                          
                  </td>
                  <td>
                      <a class="btn btn-primary btn-sm" href="{{url('/class/seeclasses/'.$class->id)}}">All courses</a>
                  ...
                  <td>
                    ...
                    <a href="{{url('/class/addstudent/toclass/'.$class->id)}}" class="btn btn-success btn-sm">Add student</a>
                          
                  </td>
                  <!-- <td>
                      <a class="btn btn-primary btn-sm" href="{{url('/class/seestudents/'.$class->id)}}"> See All Students</a>
